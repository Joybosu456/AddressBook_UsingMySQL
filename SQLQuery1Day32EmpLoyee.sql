...
--UC3
insert into employee_payroll values (101,'joy','52000','2022/01/01'),
(304,'Avik','58000','2021/05/14')
...
insert into employee_payroll values (201,'Subho','91050','2019/01/01'),
(201,'Sghfh','95050','2018/01/08'),
(201,'Rabin','81050','2020/01/01'),
(204,'Gopal','80000','2020/05/14')
...
update employee_payroll set gender='M' where name='joy' or name='avik' or name'Raja' ,or name='Shahan' or name='Raphael';
